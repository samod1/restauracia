...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><a onclick="return confirm('Chcete vymazat tento recept');" class="btn btn-danger" href="../odstranenie_receptu.php?id=<?php echo $row["id"]?>&zmazat=ano"><i class="fa fa-trash"></i> Odstranit recept</a></td>
